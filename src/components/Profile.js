...
class Profile extends Component {
    ...
    deleteUser = async (event) => {
        ...
        const response = await axios.delete(`http://localhost:3005/user/${this.props.loggedUser.id}` || `https://beer-encyclopaedia.herokuapp.com/user/${this.props.loggedUser.id}`);
    ...
    editProfile = async (event) => {
        ...
        const response = await axios.put(`http://localhost:3005/user/${this.props.loggedUser.id}` || `https://beer-encyclopaedia.herokuapp.com/user/${this.props.loggedUser.id}`, userDetails)
